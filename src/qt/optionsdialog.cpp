    ...
    mapper(nullptr)
{
    ...
    ui->openBIGKEYCOINConfButton->setToolTip(ui->openBIGKEYCOINConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new BIGKEYCOINUnits(this));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSBGKControls);
...
void OptionsDialog::on_openBIGKEYCOINConfButton_clicked()
{
