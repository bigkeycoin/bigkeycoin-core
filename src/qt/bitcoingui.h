...
/**
  BIGKEYCOIN GUI main class. This class represents the main window of the BIGKEYCOIN UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class BIGKEYCOINGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit BIGKEYCOINGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~BIGKEYCOINGUI();
...
public Q_SLOTS:
    ...
    /** Load Partially Signed BIGKEYCOIN Transaction from file or clipboard */
