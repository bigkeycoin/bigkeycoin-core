// Copyright (c) 2009-2018 The BIGKEYCOIN Core developers
...
void URITests::uriTests()
{
    ...
    QVERIFY(!GUIUtil::parseBIGKEYCOINURI(uri, &rv));
    ...
    QVERIFY(GUIUtil::parseBIGKEYCOINURI("bitcoin:175tWpb8K1S7NmH4Zx6rewF9WQrcZv245W?message=Wikipedia Example Address", &rv));
    QVERIFY(rv.address == QString("175tWpb8K1S7NmH4Zx6rewF9WQrcZv245W"));
    QVERIFY(rv.label == QString());
