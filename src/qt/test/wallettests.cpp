// Copyright (c) 2015-2021 The BIGKEYCOIN Core developers
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<BIGKEYCOINAmountField*>("payAmount")->setValue(amount);
...
void TestGUI(interfaces::Node& node)
{
...

    {
        ...
        QString balanceComparison = BIGKEYCOINUnits::formatWithUnit(unit, balance, false, BIGKEYCOINUnits::SeparatorStyle::ALWAYS);
    ...
    // Amount input
    BIGKEYCOINAmountField* amountInput = receiveCoinsDialog.findChild<BIGKEYCOINAmountField*>("reqAmount");
