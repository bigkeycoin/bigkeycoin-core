// Copyright (c) 2018-2021 The BIGKEYCOIN Core developers
...
//! Entry point for BIGKEYCOINApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &BIGKEYCOINApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for BIGKEYCOINGUI tests.
void AppTests::guiTests(BIGKEYCOINGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &BIGKEYCOINGUI::consoleShown, this, &AppTests::consoleTests);
