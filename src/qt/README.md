This directory contains the source code for the BIGKEYCOIN Core graphical user interface (GUI). It uses the [Qt](https://www1.qt.io/developers/) cross-platform framework.
...
- Represents the main window of the BIGKEYCOIN UI.
...
* UI elements like BIGKEYCOINAmountField, which inherit from QWidget.
* `bitcoinstrings.cpp`: automatically generated
* `bitcoinunits.(h/cpp)`: BGKC / mBGKC / etc. handling
* `callback.h`
...
9. You're all set! Start developing, building, and debugging the BIGKEYCOIN Core GUI
