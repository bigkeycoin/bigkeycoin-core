...
{
    const char* pszTimestamp = "La apertura de la nueva generacion, Marzo 2022";
...
public:
	...
	pchMessageStart[0] = 0x6c;
        ...
        genesis = CreateGenesisBlock(1645396632, 310600, 0x1e0fffff, 1, 0);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0000065a259fb2c8c69b4ad3d3930be9f46d149be9d93aafeb0cb15dc479b451"));
        assert(genesis.hashMerkleRoot == uint256S("96d7c0ae588826ae827429debc6bf915dd5e24a503b33e69f88093fca10bdd1e"));
