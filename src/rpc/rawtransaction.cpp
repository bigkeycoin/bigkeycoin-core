                             ...
                             {RPCResult::Type::ARR, "vout", "",
                             {
                                 {RPCResult::Type::OBJ, "", "",
                                 {
                                     ...
                                     {RPCResult::Type::OBJ, "scriptPubKey", "",
                                     {
                                         ...
                                         {RPCResult::Type::STR, "address", /*optional=*/true, "The BIGKEYCOIN address (only if a well-defined address exists)"},
                                     }},
                                 }},
                             }},
...
static RPCHelpMan decodepsbt()
{
    return RPCHelpMan{
        "decodepsbt",
        "Return a JSON object representing the serialized, base64-encoded partially signed BIGKEYCOIN transaction.",
                {
...
static RPCHelpMan combinepsbt()
{
    return RPCHelpMan{"combinepsbt",
                "\nCombine multiple partially signed BIGKEYCOIN transactions into one transaction.\n"
