// Copyright (c) 2020-2021 The BIGKEYCOIN Core developers
...
FUZZ_TARGET(crypto_diff_fuzz_chacha20)
{
    ...
    ChaCha20 chacha20;
    ECRYPT_ctx ctx;
    // D. J. Bernstein doesn't initialise ctx to 0 while BIGKEYCOIN Core initialises chacha20 to 0 in the constructor
    for (int i = 0; i < 16; i++) {
        ctx.input[i] = 0;
    }
