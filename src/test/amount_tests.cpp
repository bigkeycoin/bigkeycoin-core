// Copyright (c) 2016-2021 The BIGKEYCOIN Core developers
...
BOOST_AUTO_TEST_CASE(BinaryOperatorTest)
{
    ...
    BOOST_CHECK(b >= a);
    BOOST_CHECK(b >= b);
    // a should be 0.00000002 BGKC/kvB now
    a += a;
    BOOST_CHECK(a == b);
}
...
BOOST_AUTO_TEST_CASE(ToStringTest)
{
    CFeeRate feeRate;
    feeRate = CFeeRate(1);
    BOOST_CHECK_EQUAL(feeRate.ToString(), "0.00000001 BGKC/kvB");
    BOOST_CHECK_EQUAL(feeRate.ToString(FeeEstimateMode::BGKC_KVB), "0.00000001 BGKC/kvB");
